...
#docker run -d --name=$container_name -e MYSQL_ROOT_PASSWORD=$root_password -e MYSQL_USER=$user -e MYSQL_PASSWORD=$password -e MYSQL_DATABASE=$database -v /home/Sql:/docker-entrypoint-initdb.d -p 3306:3306 mysql:8
